export default {
    contact: {
        ...
        name: 'Contact',
        fields: [
            { name: 'name', label: 'Full Name', placeholder: 'ABC', required: true },
            { name: 'title', label: 'Your Job Title', placeholder: 'Job Title' },
            ...
            { name: 'linkedin', label: 'Linked', placeholder: 'linkedin.com/in/ABC' },
            { name: 'github', label: 'Github', placeholder: 'github.com/ABC' },
            { name: 'blogs', label: 'Blogs', placeholder: 'github.com/ABC' },
            { name: 'twitter', label: 'Twitter', placeholder: 'github.com/ABC' },
            { name: 'portfolio', label: 'Portfolio', placeholder: 'ABC.com' },
        ],
    },
    summary: {
        name: 'Summary',
